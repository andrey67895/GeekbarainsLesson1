...
public class SubmitBtnListenerClick implements ActionListener {
    private final JTextField inputField;
    private final JButton submitButton;
    private final Transmitter transmitter;

    public SubmitBtnListenerClick(JTextField inputField, JButton submitButton, Transmitter transmitter) {
